...
Integral to the function of Erlang programs is assignment as a result of pattern matching, when the inputs of a function or the values in a received message match those variables are assigned and later used. This process contains several non-obvious complexities:
\begin{itemize}
...
\begin{figure}[th]
	...
	...
	\end{verbatim}
	\caption{Erlang code demonstrating various conditional logic syntax}
	\label{fig:conditionExample:erl}
\end{figure}
\begin{figure}[th]
	\centering
	\begin{verbatim}
	...
	...
	\end{verbatim}
	\caption{Core Erlang AST generated from Figure \ref{fig:conditionExample:erl}}
	\label{fig:conditionExample:erl_ast}
\end{figure}
