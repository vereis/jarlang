...
So while \textit{estree.erl} allows you to generate our implementation of JavaScript AST nodes by simply calling functions such as \textit{estree:this\_expression()}, we also need a way to translate these datastructures into valid JSON for code generation.
